                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                         ...
                         <li>
                       		 <s:url action="getClusterData" var="delivery" >
    								...
    								<%-- <s:param name="clusterName2"><s:property value="@Util.ConstantString@SERVICE"/></s:param> --%>
    								</s:url>
                          <s:a href="%{delivery}">
                        ...
                        <li>
                       		 <s:url action="getClusterData" var="service" >
    								...
    								<%-- <s:param name="clusterName2"><s:property value="@Util.ConstantString@DELIVER"/></s:param> --%>
    								</s:url>
                          <s:a href="%{service}">
                        ...
                        <li>
                       		 <s:url action="getClusterData" var="CFO" >
    								<s:param name="clusterName1"><s:property value="@Util.ConstantString@CFOSTRING"/></s:param>
    							<%-- 	<s:param name="clusterName2"><s:property value="@Util.ConstantString@PEOPLEMGMT"/></s:param> --%>
    								</s:url>
                          <s:a href="%{CFO}">
                        ...
                        <li>
                         ...
                         <li>
    							...
    							<s:param name="clusterName1"><s:property value="@Util.ConstantString@ITINFRA"/></s:param>
    								</s:url>
                          <s:a href="%{IT}">
                         ...
                         <li>
                       		 <s:url action="getClusterData" var="Sales" >
    								<%-- <s:param name="clusterName1"><s:property value="@Util.ConstantString@DELIVER"/></s:param>--%>
    								<s:param name="clusterName1"><s:property value="@Util.ConstantString@SALES"/></s:param> 
    								</s:url>
                          <s:a href="%{Sales}">
