...
public class Utility {
	 public  String newline = System.getProperty("line.separator");
	  List<Map<String,String>> urlVal=new ArrayList<Map<String,String>>();
	 ...
	 public  String getVideoId(String url) {
		 ...
		 public  void play(String videoId, int format, String encoding, String userAgent, File outputdir, String extension) throws Throwable {
		    ...
		    for (NameValuePair pair : infoMap) {
		     ...
		     if (key.equals("token")) {
		      ...
		      for (String fmt : formats) {
		       ...
		       Map<String,String> getVideoParam=new HashMap<String,String>();
				for (String urlStr : fmtPieces) {
					String[] keyString = urlStr.split("=");

					getVideoParam.put(keyString[0], java.net.URLDecoder.decode(keyString[1], "UTF-8"));
					urlVal.add(getVideoParam);

				}
				System.out.println(urlVal);
				for(Map<String, String> videoParam :urlVal){
				Iterator<Entry<String,String>> iterator = videoParam.entrySet().iterator();
				while (iterator.hasNext()) {
					Map.Entry<String,String> entry = (Map.Entry<String,String>) iterator.next();
					System.out.println(entry.getKey() + " :" + entry.getValue());
					if(entry.getKey().equals("url"))
					{
						String result = java.net.URLDecoder.decode(entry.getValue(), "UTF-8");
		 ...
		 public  URI getUri(String path, List<NameValuePair> qparams) throws URISyntaxException {
		 ...
		 public  String getStringFromInputStream(String encoding, InputStream instream) throws UnsupportedEncodingException, IOException {
